...
const RIYA: PatientData = {
  alerts: [
    { sev:'LOW', t:'Luteal phase has been running ~16–17 days across recent cycles' },
    { sev:'LOW', t:'All blood markers currently sitting within the typical reference range' },
    { sev:'LOW', t:'Mid-luteal progesterone could add useful context if conception planning is active' },
  ],
  ...
  cycles: [
    { id:'C1', start:'Dec 20 2025', end:'Jan 18 2026', period:5, len:30, ov:'Jan 02', ovDay:14, notes:'Long luteal 16d', flag:false,
      temps: buildTemps(30, 14, 92.0, 93.4) },
    { id:'C2', start:'Jan 19 2026', end:'Feb 17 2026', period:5, len:30, ov:'Feb 01', ovDay:14, notes:'Long luteal 16d', flag:false,
      temps: buildTemps(30, 14, 92.0, 93.5) },
    { id:'C3', start:'Feb 18 2026', end:'Mar 19 2026', period:5, len:30, ov:'Mar 02', ovDay:13, notes:'Long luteal 17d', flag:false,
      temps: buildTemps(30, 13, 91.9, 93.4) },
    { id:'C4', start:'Mar 20 2026', end:'Apr 18 2026', period:5, len:30, ov:'Apr 01', ovDay:13, notes:'Long luteal 17d', flag:false,
  ...
  supps: [
    ...
    { k:'Creatine monohydrate', d:'5g · morning',     a:92,  i:'Strength + cognitive support' },
  ...
  insights: [
    { t:'Luteal phase (~16–17 days) appears consistent across the last 4 cycles', c:91 },
    { t:'Pilates 4x/week appears to be the strongest HRV correlator in the log', c:86 },
    { t:'Stress scores have been trending lower alongside a regular meditation routine', c:84 },
    { t:'On days creatine was taken, sleep latency appeared a few minutes longer than baseline', c:78 },
    { t:'Sleep duration has been steady (~7.5–7.9h) alongside gradual HRV gains', c:82 },
    { t:'No clearly negative habit patterns observed in the current logging window', c:78 },
  ],
  insightsAlerts: [
    { sev:'LOW', title:'Long luteal phase observed; mid-luteal progesterone could add context if planning' },
    { sev:'LOW', title:'No active concerns observed in recent data' },
    { sev:'LOW', title:'Preconception supplement stack appears to be running consistently' },
  ],
  strengths: [
    'Clear biphasic shift observed across all 4 recent cycles',
    'All blood markers currently sitting in the optimal range',
    'Extended luteal phase pattern observed consistently',
    'Supplement adherence ~92% alongside a balanced lifestyle log',
  ],
  concerns: [
    'Long luteal phase worth keeping in view if conception is being planned',
    'No major modifiable risk factors observed in current data',
    'Regimen appears stable from the current logs',
    'AMH worth re-checking in ~12 months for context',
  ],
  partner: [
